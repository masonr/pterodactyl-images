...
if [[ "$INSTALLED" != "$MODULE" ]] ; then
	...
	if [[ "$MODULE" == "Native" ]] ; then # M&B Warband Native Install
		...
		wget -qO- https://files.rowe.sh/wineconsole/warband/nw/nw-latest.tar.gz | tar xvz --strip-components=1
		wget -qO- https://files.rowe.sh/wineconsole/warband/nw/bc-latest.tar.gz | tar xvz --strip-components=1
		...
		wget -qO- https://files.rowe.sh/wineconsole/warband/nw/nw-latest.tar.gz | tar xvz --strip-components=1
		wget -qO- https://files.rowe.sh/wineconsole/warband/nw/ie-latest.tar.gz | tar xvz --strip-components=1
		...
		wget -qO- https://files.rowe.sh/wineconsole/warband/nw/nw-latest.tar.gz | tar xvz --strip-components=1
		wget -qO- https://files.rowe.sh/wineconsole/warband/nw/ps-latest.tar.gz | tar xvz --strip-components=1
		cp -rf /home/container/Sample_Team_Deathmatch.txt /home/container/Config.txt
	elif [[ "$MODULE" == "Red and Blue 1936 v2.1" ]] ; then # Red and Blue 1936 Install
		wget -qO- https://files.rowe.sh/wineconsole/warband/nw/nw-latest.tar.gz | tar xvz --strip-components=1
		wget -qO- https://files.rowe.sh/wineconsole/warband/nw/rab-latest.tar.gz | tar xvz --strip-components=1
		...
		wget -qO- https://files.rowe.sh/wineconsole/warband/nw/nw-latest.tar.gz | tar xvz --strip-components=1
		wget -qO- https://files.rowe.sh/wineconsole/warband/nw/wo1812-latest.tar.gz | tar xvz --strip-components=1
