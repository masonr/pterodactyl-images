...
MB_WB_NATIVE_MODS=( "The Deluge" "FI2 Amber 2.0" "Full Invasion Osiris" "Mount and Gladius V1.0" "PW_4.5" )
...
MB_WB_LINKS["Full Invasion Osiris"]="https://files.rowe.sh/pterodactyl/mb-warband/native/fio-latest.tar.gz"
